...
- La presentación mantiene los bloques operativos del Excel: liquidación diaria, seis días, M.S diario/semanal, 3%, clientes nuevos y cadena de 11 semanas. El resultado neto dinámico es `COBRADO − PRÉSTAMOS − GASTOS TOTALES + M.S`; los importes históricos ya importados no se reescriben.

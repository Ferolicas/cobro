...
- Cada conexión recuperada, vuelta a primer plano o foco de ventana fuerza una resincronización.
- Mientras el socket está caído se intenta reconectar cada 15 segundos; una reconciliación defensiva cada 60 segundos cubre eventos perdidos y cambios por fecha.
